...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots
        ...
        //this();  // improve, for optional extra education
      	...
      	ArrayList<Integer> unorderedCopy = unordered;
      	for(Integer i : unorderedCopy) {
      		list_iAS.add(unorderedCopy.remove(champIndex(unorderedCopy)));
        }
     ...
     */
     private int champIndex( ArrayList<Integer> challengers) {
       	int minIndex = 0;
       	int counter = 0;
       	for (Integer i : challengers) {
          if (i != null && i.intValue() <= challengers.get(minIndex).intValue()) {
          	minIndex = counter;
          }
          counter++;
        }
